...
import { Core as YubinBangoCore2 } from 'yubinbango-core2';
...
const fetchAddress = () => {
  new YubinBangoCore2(String(form.postcode), (value) => {
                ...
                <div class="container px-5 py-8 mx-auto">
                  <div class="lg:w-1/2 md:w-2/3 mx-auto">
                    <div class="flex flex-wrap -m-2">
                      ...
                      <div class="p-2 w-full">
                        <div class="relative">
                          <label for="kana" class="leading-7 text-sm text-gray-600">仮名</label>
                          <input
                            type="text"
                            id="kana"
                            name="kana"
